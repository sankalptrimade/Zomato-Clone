...
import { NightLifeRestaurants } from '../../data/nightLifeData';
...
const nightLife = NightLifeRestaurants
...
const NightLife = () => {
  return (
    <div>
      ...
      <ExploreSection list={nightLife} collectionName="Nightlife: Night clubs, pubs and bar in Hyderabad"/>
    </div>
  )
}
